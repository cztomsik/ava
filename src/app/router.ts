...
const routes = [
  ...
  EXP && { path: "/quick-tools", component: QuickTools },
  EXP && { path: "/quick-tools/new", component: CreateTool },
  EXP && { path: "/quick-tools/:id", component: QuickTool },
  EXP && { path: "/quick-tools/:id/edit", component: EditTool },
